...
const upcomingEvents = [
  {
    ...
    desc: "A multisensory morning weaving therapeutic scent rituals with live sound healing. Expect handcrafted aromatherapy blends, crystal singing bowls, and a deeply restorative close.",
    img: IMG.candles,
  },
  {
    num: "02",
    ...
    desc: "The closing chapter of our Spring sound series. Live vocal harmonics meet a full gong and bowl immersion — an evening of profound stillness and community.",
    img: IMG.bowls,
  },
];
    ...
    <>
      <Box py={{ base: 20, md: 32 }}>
        ...
        <motion.div {...fade(0.35)}>
          <Text
            fontFamily="'Raleway', sans-serif"
            fontSize="sm" color={MUTED} lineHeight="1.85" maxWidth="380px" mb={10}
          >
            Intimate, curated wellness events across London. Each one designed
            to help you slow down, feel more, and leave lighter.
          </Text>
          <TextLink href={LINKTREE}>Book on Instagram</TextLink>
        </motion.div>
      </Box>
                ...
                <SimpleGrid columns={{ base: 1, md: 2 }} gap={{ base: 8, md: 16 }}>
                  ...
                  <Box>
                    ...
                    <Heading
                      ...
                      color={TEXT} lineHeight="1.2" mb={2}
                    >
                      {name}
                    </Heading>
                    <Text
                      fontFamily="'Raleway', sans-serif"
                      fontSize="xs" color={MUTED} mb={6}
                    >
                      {type}
                    </Text>
                    ...
                    <Flex direction="column" gap={2} mb={8}>
                      {[["Date", date], ["Time", time], ["Location", location]].map(([k, v]) => (
                        <Flex key={k} gap={4} align="center">
                          ...
                          <Text
                            fontFamily="'Raleway', sans-serif"
                            fontSize="xs" color={TEXT} letterSpacing="0.04em"
                          >
                            {v}
                          </Text>
                        </Flex>
                    ...
                    <TextLink href={LINKTREE}>Reserve your spot →</TextLink>
                  </Box>
...
function WhatToExpectSection() {
  const expects = [
    ...
    { title: "Guided experience",   body: "Led by expert practitioners with deep knowledge of their modalities." },
    { title: "Community",           body: "Small group sizes so you can genuinely connect, not just be in the same room." },
    { title: "Nourishment",         body: "We partner with conscious wellness brands to bring you drinks and products to take home." },
  ];
  ...
  return (
    <motion.div {...fade(0)}>
      ...
      <Row label="Past experiences" py={12}>
        <Box>
          {pastEvents.map(({ name, type, date }, i) => (
            <Flex
              key={name}
              borderBottom={`1px solid ${BORDER}`} py={4}
            ...
            >
              <Box>
                <Text
                  fontFamily="'Playfair Display', serif"
                  fontSize="lg" color={MUTED} mb="2px"
                >
                  {name}
                </Text>
                <Text fontFamily="'Raleway', sans-serif" fontSize="xs" color={MUTED} opacity={0.6}>
                  {type}
                </Text>
              </Box>
              <Text fontFamily="'Raleway', sans-serif" fontSize="xs" color={MUTED} letterSpacing="0.06em">
                {date}
              </Text>
            </Flex>
          ))}
          ...
          <SimpleGrid columns={{ base: 1, md: 2 }}>
            ...
            >
              ...
              <Heading
                ...
                color="#f5f0eb" lineHeight="1.15"
              >
                New events drop
                <br /><em>on Instagram first.</em>
              </Heading>
              <Text
                fontFamily="'Raleway', sans-serif"
