  ...
  return (
    <Box id="offerings" style={{ scrollMarginTop: "80px" }}>
      ...
      <Box py={{ base: 10, md: 14 }}>
        ...
        <SimpleGrid columns={{ base: 1, md: 3 }} gap={{ base: 10, md: 8 }} mt={8}>
          {offerings.map(({ num, title, img, desc, includes }, i) => (
            <motion.div key={num} {...fade(i * 0.08)}>
              <Box>
                <Box overflow="hidden" mb={5} style={{ aspectRatio: "4 / 5" }}>
                ...
                <Text fontFamily="'Raleway', sans-serif" fontSize="10px"
                  letterSpacing="0.24em" color={MUTED} mb={2}
                >{num}</Text>
                <Heading fontFamily="'Playfair Display', serif" fontWeight="400"
                ...
                <Text fontFamily="'Raleway', sans-serif" fontSize="14px"
                  color={MUTED} lineHeight="1.85" mb={5}
                >{desc}</Text>
